...
int main()
{
    ...
    for (auto direction : CableADirections)
    {
        ...
        if (direction == 'U')
        {
            ...
            {
                timer++;
                map[PointerX][PointerY + cell]['A'] = timer;
            }
        ...
        else if (direction == 'R')
        {
            ...
            {
                timer++;
                map[PointerX + cell][PointerY]['A'] = timer;
            }
            ...
            for (auto cell : Range)
            {
                ...
                if (map.count(PointerX))
                {
                    if (map[PointerX].count(PointerY))
                    {
                        ...
                        {
                            std::cout << "X : " << PointerX << " | Y : " << PointerY << " | timer : " << map[PointerX][PointerY]['A'] + timer << std::endl;
                            CrossingDistances.push_back(map[PointerX][PointerY]['A'] + timer);
                        }
                    }
                }
            }
